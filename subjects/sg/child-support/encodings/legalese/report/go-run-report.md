...
|             |                                                                                  |
| ----------- | -------------------------------------------------------------------------------- |
| run id      | `2026-08-25-423e1cb8-001`                                                                     |
...
| repo HEAD   | `10a92e9ce069352fa8739fbcad032f97d52695a6` (dirty)                                         |
...
| journal     | `/var/folders/jv/4t5pmlz5563gttw9cxqlx5k00000gp/T/l4-go/2026-08-25-423e1cb8-001/journal.ndjson` — 24 records, chain verifies |
| verdict     | **COMPLETE**                                                              |
...
| `jl4/examples/legal/sg-child-support/sg-csp.l4` | `sha256:db94c0e31ca3a694f37a3f99f756ea495f6699b91672e4e02a5859edb6bd9038` |
| `jl4/examples/legal/sg-child-support/sg-childcare-leave.l4` | `sha256:59049099727a46decdeb22e649fa2245b7bed192720ad0a51811a65305b174b1` |
...
| `jl4/examples/legal/sg-child-support/sg-child-support.l4` | `sha256:8351c0dd9d8b84d18d7e9bdf907dfe21bb15e272e933ce2276e655d1c14166d7` |
| `jl4/examples/legal/sg-child-support/sg-child-support-cases.l4` | `sha256:149414f00c521e56ef0b8e2aba0cbb647f40aee45a7f9e70d3920dc428b4e782` |
...
> *claimed, not verified* (phase-script): Rung 1 of 3. R5 (2026-08-02) ordered the P8 ladder as ROBDD first, the R4 fork-space agreement/divergence sweep second, an external model checker (TLA+/NuSMV/UPPAAL class) last. Rungs 2 and 3 are unbuilt: rung 2 needs the fork register P4 does not yet produce, rung 3 waits on the LTS semantics. 102 of 107 decisions are outside rung 1 entirely because they do not return BOOLEAN — they are counted, named in the artifact, and not reported as clean. A further 37 are outside it for a different reason: they are defined inside a WHERE clause, and neither this command nor the ladder's own entry point descends into one, so they are in NEITHER the analysed nor the skipped column. That is why the figure is on the receipt: 'analysed + skipped' does not total the corpus, and an exclusion nobody can size is an exclusion nobody believes.
...
| ----- | ------ | ------: | -------: | - |
| `p0-preflight` | PASS | 10s | 501 ms |  |
| `p3-check` | PASS | 17s | 436 ms |  |
| `p6-tests` | PASS | 28s | 601 ms |  |
| `p8-verify` | PASS | 33s | 552 ms |  |
| `p7-lts` | NOT-BUILT | 4s | 511 ms |  |
| `p7-mcp` | SKIPPED | 56 ms | 493 ms |  |
| `p7-akn` | UNVERIFIED | 4s | 463 ms |  |
| `p9-cost` | PASS | 754 ms | 259 ms |  |
| `p9-report` | PASS | 355 ms | 270 ms |  |
| `p9-explain` | SKIPPED | 39 ms | 218 ms |  |
| **total** | | **1m 39s** | **4s** | |
...
**Wall clock.** The run spans 1m 46s from its first journal record to its last. Of that, 1m 39s is attested stage execution, and at least 0 ms is measured tool-call time, giving a floor of 1m 39s during which something was demonstrably running. Both component figures stop where the attributed ones do; the span does not.
...
| `p0-preflight` | `tripwire.json` | 519 | `sha256:916ae75b46fc5f71…` | on disk |
...
| `p6-tests` | `sg-child-support-cases.run.json` | 19656 | `sha256:a148dd70017f390e…` | on disk |
...
| `p8-verify` | `sg-csp.verify.json` | 6149 | `sha256:d2a7b72809f654cc…` | on disk |
| `p8-verify` | `sg-csp.verify.txt` | 8127 | `sha256:76c1bd4c085b1e59…` | on disk |
| `p8-verify` | `sg-childcare-leave.verify.json` | 3268 | `sha256:d13050b89b3617cc…` | on disk |
| `p8-verify` | `sg-childcare-leave.verify.txt` | 5614 | `sha256:8488dfe07d0400a7…` | on disk |
...
| `p8-verify` | `sg-child-support.verify.json` | 1483 | `sha256:aeed83e938df90aa…` | on disk |
| `p8-verify` | `sg-child-support.verify.txt` | 4108 | `sha256:3b6b2ebabb6ae6db…` | on disk |
...
| `p8-verify` | `p8-verify.txt` | 1138 | `sha256:c3f6ff956c39978e…` | on disk |
| `p7-lts` | `p7-lts.stderr` | 36 | `sha256:0d882bf9d3984abc…` | on disk |
| `p7-mcp` | `sg-child-support-deployable.zip` | 23590 | `sha256:04f2d491658e60da…` | on disk |
| `p7-mcp` | `p7-mcp.txt` | 162 | `sha256:79c38244a2e936db…` | on disk |
| `p7-akn` | `sg-child-support.akn.xml` | 40836 | `sha256:760e0ef46e9ceeb4…` | on disk |
| `p7-akn` | `p7-akn.txt` | 99 | `sha256:98d88b13e17a41f4…` | on disk |
| `p9-cost` | `cost-ledger.json` | 10090 | `sha256:a798b1aa0cc76ced…` | on disk |
| `p9-cost` | `p9-cost.txt` | 0 | `sha256:e3b0c44298fc1c14…` | on disk |
| `p9-report` | `report.md` | 24253 | `sha256:b74529344e3bd125…` | on disk |
| `p9-report` | `report.html` | 24680 | `sha256:3809bff4cd821e65…` | on disk |
| `p9-report` | `p9-report.txt` | 242 | `sha256:2fd3f258b872aa58…` | on disk |
...
*Generated by `etc/go/report/render-report.mjs` from `/var/folders/jv/4t5pmlz5563gttw9cxqlx5k00000gp/T/l4-go/2026-08-25-423e1cb8-001/journal.ndjson`. Nothing in this report was typed; every figure resolves from a journal row.*
