...
for the 2026-09-21 s 393 addition below**, so `tests/robbery-390-392.*.golden` and
`tests/charge-sheet.*.golden` predate it and will not match until someone re-blesses them.
