...
The quoted text of **Motor Vehicles (Third-Party Risks and Compensation) Act 1960** is sourced from
[Singapore Statutes Online](https://sso.agc.gov.sg/) at https://sso.agc.gov.sg/Act/MVTPRCA1960, provided by the
...
- **Retrieved**: 2026-09-22, from https://sso.agc.gov.sg/Act/MVTPRCA1960
...
- **Extraction window** (cl.13(d)(i)): not yet engaged. No text has been
  deposited; the nightly harvest will fetch it inside the 3 a.m. to 7 a.m. window.
